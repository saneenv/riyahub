            ...
            <div className=' flex justify-center items-center bg-[#0D2D3E] py-12'>
                <div className='lg:w-[80%] w-[90%] h-[70%]  flex flex-col items-center bg-[white]  gap-12 py-12 lg:rounded-[20px] rounded-[5px]'>
                    ...
                    <div className='grid lg:grid-cols-3 grid-cols-1 gap-5 lg:px-12 px-3 w-full'>
                        ...
                        <div className='flex flex-col gap-3'>
                            <span className='text-left text-lg font-[500] font-[display]'>State</span>
                            <input type="text" className='h-[43px] w-full  border-2 border-[#D7D7D7] rounded-[5px] px-4' />
                        </div>
                        ...
                        <div className='flex flex-col gap-3'>
                            <span className='text-left text-lg font-[500] font-[display]'>Whatsapp No.</span>
                            <input type="text" className='h-[43px] w-full  border-2 border-[#D7D7D7] rounded-[5px] px-4' />
                        </div>
                    ...
                    <div className='flex flex-col gap-5 w-full px-12 justify-center items-center'>
                        <div className='h-[56px] lg:w-[25%] w-[50%] bg-[#E22E37] rounded-[20px] flex justify-center items-center text-[white] text-xl font-[display] font-[600]'>Register</div>
