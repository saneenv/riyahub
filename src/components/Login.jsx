    ...
    return (
        <div className='flex flex-col min-h-screen'>
            ...
            <div className=' flex justify-center items-center bg-[#0D2D3E] py-7'>
                <div className='lg:w-[30%] w-[50%] h-[70%] bg-[white]  flex flex-col items-center  gap-12 py-12 lg:rounded-[20px] rounded-[5px]'>
                    ...
                    <div className='w-full h-auto gap-3 flex flex-col mt-5'>
                        <div className='h-[56px] w-full px-12 ' >
                            <input type="text" className='border-2 border-[#000000] w-full h-full rounded-[12px] px-3 ' placeholder='Enter your email or Mobile Number' />
                        </div>
                        <div className='h-[56px] w-full px-12 ' >
                              <div className='w-full h-full bg-[#E22E37]  rounded-[28px] flex justify-center items-center text-[white] text-base font-[600] font-[display] cursor-pointer'>
                              SUBMIT
                              </div>
                        </div>
