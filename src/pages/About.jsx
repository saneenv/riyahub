    ...
    return (
        <div className='min-h-screen flex flex-col'>
            ...
            <div className='lg:px-12 px-3 lg:py-12 py-3 flex flex-col min-h-screen gap-8'>
                ...
                <div className='w-full flex justify-center items-center text-[#E22E37] text-4xl font-[700] font-[display]'>About Us</div>

                <div className='w-full flex flex-col gap-10'>
                    <div className='flex flex-col w-full gap-4 text-left'>
                        <span className='text-2xl font-[600] font-[display]'>Welcome to RIYA HUB JOBS</span>
                    ...
                    <div className='flex flex-col w-full gap-4 text-left'>
                        <span className='text-2xl font-[600] font-[display]'>Who We Are</span>
                    ...
                    <div className='flex flex-col w-full gap-4 text-left'>
                        <span className='text-2xl font-[600] font-[display]'>What We Offer</span>
                        <div className='text-lg font-[400] font-[display] flex flex-col gap-6'>
                            <div className='flex lg:flex-row flex-col'>

                                <span className='font-[800]'>. Comprehensive Job Listings</span> : We feature a wide
                            ...
                            <div className='flex lg:flex-row flex-col'>
                                ...
                                <span className='font-[800]'>. User-Friendly Platform</span> : Our intuitive interface
                            ...
                            <div className='flex lg:flex-row flex-col'>
                                ...
                                <span className='font-[800]'>. Resources & Support</span> : We provide valuable resources,
                            ...
                            <div className='flex lg:flex-row flex-col'>
                                ...
                                <span className='font-[800]'>. Employer Solutions</span> : We help businesses
                    ...
                    <div className='flex flex-col w-full gap-4 text-left'>
                        <span className='text-2xl font-[600] font-[display]'>Our Value</span>
                        <div className='text-lg font-[400] font-[display] flex flex-col gap-6'>
                            <div className='flex lg:flex-row flex-col'>

                                <span className='font-[800]'>. Integrity</span> : We operate with transparency and honesty,
                            ...
                            <div className='flex lg:flex-row flex-col'>
                                ...
                                <span className='font-[800]'>. Innovation</span> :  We continuously improve our platform
                            ...
                            <div className='flex lg:flex-row flex-col'>
                                ...
                                <span className='font-[800]'>. Community</span> :  We foster a supportive environment for
                    ...
                    <div className='flex flex-col w-full gap-4 text-left'>
                        <span className='text-2xl font-[600] font-[display]'>Join Us on This Journey</span>
                    ...
                    <div className='flex flex-col w-full gap-4 text-left'>
                        <span className='text-2xl font-[600] font-[display]'>RIYA HUB JOBS</span>
                        <div className='text-lg font-[400] font-[display] flex flex-col gap-6'>
